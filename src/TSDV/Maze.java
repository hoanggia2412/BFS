...
public class Maze {
	...
	private List<Coordinate> ends = new ArrayList<Coordinate>();
...
//					System.out.println(end);
					...
					maze[row][col] = ROAD;	
					if(col == 0 ||lines[row].length() -1 == col || row ==0 || row == getHeight()-1) {
	...
	public void setEnd(Coordinate coor) {
		end =coor;
		maze[coor.x][coor.y]= EXIT;
	}
	public int getWidth() {
	...
	public List<Coordinate> getEnds() {
		return ends;
	}
}
